...
var i18nRo = {
    "anonymous users cannot vote": "ne pare rău, utilizatorii anonimi nu pot vota  ",
    'tags cannot be empty':'introduceţi cel puţin o etichetă',
    'anonymous users cannot select favorite questions':'utilizatorii anonimi pot nu selecta întrebări favorite ',
    'upload image':'Incarcă imagine:',
    'enter image url':'Introduceţi URL-ul imaginii, ex. http://www.example.com/image.jpg sau incărcaţi o imagine',
    'enter url':'introduceţi adresa internet, ex. http://www.example.com \"titlu\"',
    'upload file attachment':'Alege un fişier pentru incărcare:',
    'daily vote cap exhausted':'ghinion, ai utilizat limita zilnică de voturi',
    'cannot pick own answer as best':'nu poţi accepta propriul răspuns',
    'please confirm offensive':'esti sigur(ă) ca acest post e ofensiv, conţine spam, anunţuri, remarci răutăcioase, etc.?',
    'flag offensive cap exhausted':'ghinion, ai utilizat limita zilnică de marcări a mesajelor ofensive ',
    'confirm delete':'esti sigur(ă) că vrei sa ştergi?',
    'anonymous users cannot delete/undelete':'utilizatorii anonimi nu pot şterge/recupera mesaje',
    'post recovered':'mesajul tău a fost recuperat!',
    'post deleted':'mesajul tău a fost şters',
    'confirm delete comment':'chiar veri să ştergi comentariul?',
    'content minchars': 'introduceţi mai mult de {0} caractere',
    'title minchars':"introduceţi cel putin {0} caractere",
    '{0} characters left': '{0} caractere rămase',
    'content cannot be empty': 'introduceţi un text',
    'characters':'caractere rămase',
    'cannot flag message as offensive twice':'nu pot marca ofensiv de două ori ',
    'edit':'editează',
    'click to edit this comment':'click pentru a edita comentariul',
    'confirm abandon comment':'Esti sigur(ă) că nu vrei să trimiţi comentariul?',
    'save comment': 'salvează comentariul',
    'enter more characters': 'introduceţi {0} sau mai multe caractere',
